...
print('recall {}'.format(recall_score(ytest, logicpred)))
print('accuary {}'.format(accuracy_score(ytest, logicpred)))
print('precision {}'.format(precision_score(ytest, logicpred)))
print()
print("sklearn gaussianNB model")
print('recall {}'.format(recall_score(ytest, naivepred)))
print('accuary {}'.format(accuracy_score(ytest, naivepred)))
print('precision {}'.format(precision_score(ytest, naivepred)))
